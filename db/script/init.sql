...
INSERT INTO SUC_USER (ID, LOGIN_NAME, LOGIN_PSWD, NICKNAME,MODIFIED_TIMESTAMP)VALUES(1,'admin','84ecd79f4cd5cd64ac472b12480a53d4', '系统管理员',UNIX_TIMESTAMP(SYSDATE()) * 1000);