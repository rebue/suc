...
public class WblAndDaMaiSuc {
    ...
    public void main() throws SQLException, IOException {
        Connection        mySqlConn = DbUtils.getMySqlConn();
        ...
        while (rs.next()) {
            ...
            if (!StringUtil.isEmpty(unionid)) {
                ...
                if (StringUtil.isEmpty(users)) {
                    ...
                    PreparedStatement getAccountStatement = mySqlConn.prepareStatement(getAccountByIdSql);
    ...
    public void add(Long id) throws SQLException, IOException {
        ...
        PreparedStatement statement     = mySqlConn.prepareStatement(getUserBIdSql);
        ResultSet         rs            = statement.executeQuery();
        while (rs.next()) {
            // 登录名称
            ...
            PreparedStatement addUserStatement = mySqlConn.prepareStatement(addUserSql);
            addUserStatement.executeUpdate();

            String            getRegByIdSql   = "SELECT * FROM suc.wbl_suc_reg where ID=" + id;
            PreparedStatement getRegStatement = mySqlConn.prepareStatement(getRegByIdSql);
            ...
            while (getRegResult.next()) {
                ...
                PreparedStatement addRegStatement = mySqlConn.prepareStatement(addRegSql);
            ...
            while (getAccountResult.next()) {
                ...
                PreparedStatement addAccountStatement = mySqlConn.prepareStatement(addAccountSql);
