...
public class SucUserSvcImpl extends MybatisBaseSvcImpl<SucUserMo, java.lang.Long, SucUserMapper> implements SucUserSvc {
    ...
    public UserRegRo regByLoginName(RegByLoginNameTo to) {
        if (StringUtils.isAnyBlank(to.getLoginName(), to.getLoginPswd(), to.getUserAgent(), to.getMac(), to.getIp()) || to.getAppId() == null) {
    ...
    public UserRegRo regByQq(RegByQqTo to) {
        if (StringUtils.isAnyBlank(to.getQqId(), to.getQqNickname(), to.getQqFace(), to.getUserAgent(), to.getMac(), to.getIp()) || to.getAppId() == null) {
    ...
    public UserRegRo regByWx(RegByWxTo to) {
        if (StringUtils.isAnyBlank(to.getWxId(), to.getWxOpenid(), to.getWxNickname(), to.getUserAgent(), to.getMac(), to.getIp()) || to.getAppId() == null) {
    ...
    public UserLoginRo loginByUserName(LoginByUserNameTo to) {
        if (StringUtils.isAnyBlank(to.getUserName(), to.getLoginPswd(), to.getUserAgent(), to.getMac(), to.getIp()) || to.getAppId() == null) {
    ...
    public BindWxRo bindWx(BindWxTo to) {
        if (to.getUserId() == null || to.getAppId() == null || StringUtils.isAnyBlank(to.getWxId(), to.getWxNickname(), to.getUserAgent(), to.getMac(), to.getIp())) {
