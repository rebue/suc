...
INSERT INTO SUC_USER (ID, LOGIN_NAME, LOGIN_PSWD, SALT, NICKNAME,MODIFIED_TIMESTAMP)VALUES(1,'admin','bc9db97ebf008d9acf54b333bd6f94ca','zcSeWA', '系统管理员',UNIX_TIMESTAMP(SYSDATE()) * 1000);