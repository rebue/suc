...
public class LoginCtrl {
	...
	UserLoginRo loginByLoginName(@RequestBody LoginByLoginNameTo loginTo, HttpServletRequest req,
	...
	UserLoginRo loginByUserName(@RequestBody LoginByUserNameTo loginTo, HttpServletRequest req,
			HttpServletResponse resp) {
		_log.info("login: " + loginTo);
		loginTo.setIp(AgentUtils.getIpAddr(req, passProxy));
		loginTo.setUserAgent(AgentUtils.getUserAgent(req));
