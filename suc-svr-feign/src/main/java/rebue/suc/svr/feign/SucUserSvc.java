...
public interface SucUserSvc {
    ...
    PageInfo<SucUserMo> listuserbyidsAndKeys(@RequestParam("pageNum") int pageNum,
            @RequestParam("pageSize") int pageSize, @RequestParam("userIds") String userIds,
            @RequestParam("addedKeys") String addedKeys);
